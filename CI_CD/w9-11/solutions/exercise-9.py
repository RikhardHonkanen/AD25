...
print("Hello","World!",42,True,"Python is fun!")
...
gift_list.append('chocolates')
print(gift_list)


# 26. Add the list ["socks", "tshirt", "pajamas"] to the end of gift_list
gift_list = ['socks', '4K drone', 'wine', 'jam']
gift_list.extend(['socks','t-shirt','pajamas'])
# we can also use += like:gift_list += (['socks','t-shirt','pajamas'])
print(gift_list)
...
answer_1 = "Melon" in fruits
answer_2 = "Mango" in fruits
answer_3 = "Apple" in fruits
answer_4 = "Orange" in fruits
