 ...
 * @brief An MQTT Client example.
 *        Right click on README.md and then click on Open Preview
 *
 * @version 0.1
 * @date 2025-02-18
 *
...
static const char *WIFI_SSID{"MaxPlus"};
static const char *WIFI_PASS{"SV21TRC3556"};

// MQTT Server parameters (Create an account on hivemq.cloud)
static uint32_t MQTT_PORT{8883}; // The service port
static esp_mqtt_client_handle_t client;
static const char *MQTT_CLIENTID{"ESP32"};                                                     // The client ID
static const char *MQTT_USERNAME{"comnode"};                                                   // Your username
static const char *MQTT_PASSWORD{"SV21TRC3556node"};                                           // Your password
static const char *MQTT_SERVER{"mqtts://0e107749a5f143de8c5cea1c9d277417.s1.eu.hivemq.cloud"}; // The server URL
...
-----END CERTIFICATE-----
)EOF"; // downloaded from: https://letsencrypt.org/certs/isrgrootx1.pem
